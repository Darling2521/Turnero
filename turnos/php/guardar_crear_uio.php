...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $_SESSION['turno_datos'] = base64_encode("us_name=" . urlencode($us_nombres) . "&tu_nro_tur=" . urlencode($tu_nro_tur) . "&requeriments=" . urlencode($requeriments) . "&us_fec_reg=" . urlencode($us_fec_reg));

    header('Location: ../vista/turno.php');
    exit();
} else {
    header('Location: ../vista/form_uio.php');
    exit();
}
