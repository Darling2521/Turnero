...
<body class="bg-gray-100 flex items-center justify-center h-screen">
    <div class="max-w-md w-full p-8 bg-white rounded-lg shadow-md form-container">
        ...
        <form id="turnoForm" action="../php/guardar_crear_gye.php" method="POST">
            <div class="mb-4">
    ...
    <input type="text" id="us_nombres" name="us_nombres" readonly
        class="w-full border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring focus:border-blue-300 transition duration-300 disabled-look">
</div>
            <div class="mb-4">
