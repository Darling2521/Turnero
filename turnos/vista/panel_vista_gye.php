...
<div class="container mx-auto py-8">
    <div class="grid grid-cols-2 gap-8">
        ...
        <div class="flex items-center justify-center">
            <img src="../img/art1.png" alt="Imagen" class="max-w-full h-auto">
        </div>
...
function cargarTurnos() {
    fetch(`../php/obtener_turnos.php?ciudad=Guayaquil`)
    ...
    // Cargar los turnos para la ciudad especificada al cargar la página
    document.addEventListener('DOMContentLoaded', () => {
        const ciudad = 'guayaquil'; 
        cargarTurnos(ciudad);

        // Actualizar los turnos cada 5 segundos
        setInterval(() => cargarTurnos(ciudad), 5000);
    });
</script>
</body>
</html>
